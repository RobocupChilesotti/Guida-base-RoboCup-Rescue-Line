...
### Disegno
I file sono disponibili [qui]([https://we.tl/t-yPsNFrlfjO](https://github.com/gpego/3D-Files-for-RoboCup-Rescue-Line)). Sono file SolidWorks ma dovrebbero poter essere aperti con Fusion, ad ogni modo, in caso di necessità li possiamo convertire.
